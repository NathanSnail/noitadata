...
RegisterSpawnFunction( 0xffffeedd, "spawn_boss" )
...
function spawn_boss(x, y)
	...
	EntityLoad( "data/entities/animals/boss_sky/boss_sky.xml", x, y )
	LoadBackgroundSprite( "data/biome_impl/static_tile/temples-assets/boss_hint_bg.png", x-16, y-40, BG_Z )
end
