...
local gun = { }
gun.name = {"$item_chainsaw"}
gun.deck_capacity = 1
gun.actions_per_round = 1
gun.reload_time = {1,1}
gun.shuffle_deck_when_empty = 0
gun.fire_rate_wait = 1
gun.spread_degrees = 30
gun.speed_multiplier = 4.0
gun.mana_charge_speed = {200,300}
gun.mana_max = {800,900}
...
AddGunActionPermanent( entity_id, "RECOIL_DAMPER" )
...
ComponentSetValue2( item_comp, "item_name", "$item_chainsaw" )
