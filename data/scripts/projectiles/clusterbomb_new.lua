...
if ( speed < 50 ) then
	...
	for i=1,how_many do
		...
		shoot_projectile_from_projectile( entity_id, "data/entities/projectiles/deck/grenade_small.xml", pos_x + shot_vel_x * 0.05, pos_y + shot_vel_y * 0.05, shot_vel_x, shot_vel_y, false )
	end
